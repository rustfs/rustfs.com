...
const ReviewCard = ({
  ...
  return (
    ...
    >
      <blockquote className="text-sm tracking-wide text-muted-foreground">{body}</blockquote>
  ...
  return (
    <>
      <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 py-12 lg:py-20 mx-auto">
        ...
        <div className="relative flex lg:hidden h-[500px] w-full flex-row items-center justify-center overflow-hidden rounded-lg">
        ...
        <div className="relative hidden lg:flex h-[500px] w-full flex-row items-center justify-center overflow-hidden rounded-lg">
