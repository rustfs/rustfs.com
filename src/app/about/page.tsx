...
export default function Pricing() {
  ...
  return (
    <div className="leading-loose">
      ...
      <div className="text-primary-foreground relative bg-cover bg-bottom bg-no-repeat" style={{ backgroundImage: 'url(/images/about/banner.png)' }}>
            ...
            <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-2 xl:gap-12">
              <div className="space-y-20 px-12">
                <div className="relative h-32 text-2xl">
                  <div className="absolute bottom-0 left-0 z-0 -m-12 size-48 rounded-full bg-neutral-50"></div>
      ...
      <div className="text-primary-foreground relative bg-cover bg-bottom bg-no-repeat" style={{ backgroundImage: 'url(/images/about/banner-bj.png)' }}>
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto space-y-10 py-12 xl:py-24">
            <div className="space-y-12">
              <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2 xl:gap-12">
                <div className="space-y-4">
                  ...
                  <p className="text-xs">根据Fortune Business Insights的报告，全球数据存储市场预计将从2024年的2183.3亿美元增长到2032年的7740亿美元，在此期间的年复合增长率为17.1%</p>
                </div>
                <div className="space-y-20 px-12">
                  <h3 className="text-primary-foreground mb-10 text-4xl font-bold">RustFS 为全球提供安全、 可靠的分布式存储方案</h3>
                  <div className="space-y-4">
