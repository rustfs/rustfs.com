    ...
    <div className="space-y-8 leading-loose">
      ...
      <div className="bg-banner-1 relative">
        ...
        <div className="relative z-50 px-6 py-16 text-center">
          <h3 className="text-foreground text-5xl font-bold">数据生命周期管理和分层</h3>
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="container mx-auto py-12 flex items-start gap-8">
          <div className="w-1/5 p-6 rounded border shadow flex flex-col gap-4">
          ...
          <div className="w-4/5 leading-loose space-y-6">
            <div>
              <h3 id="sec1" className="font-bold text-primary text-xl">对象过期</h3>
            ...
            <div>
              <h3 id="sec2" className="font-bold text-primary text-xl">基于策略的对象分层</h3>
              <p>
            ...
            <div>
              <h3 id="sec3" className="font-bold text-primary text-xl">跨存储介质</h3>
              <p>
              ...
              <div className="p-8 border rounded-xl shadow">
                <img src="/images/s-9/s9-2.png" alt="" className="max-w-lg mx-auto" />
              </div>
            </div>
            <div>
              <h3 id="sec4" className="font-bold text-primary text-xl">跨云类型</h3>
              <p>
              ...
              <div className="p-8 border rounded-xl shadow">
                <img src="/images/s-9/s9-3.png" alt="" className="max-w-2xl mx-auto" />
              </div>
            </div>
            <div>
              <h3 id="sec5" className="font-bold text-primary text-xl">在公有云中</h3>
              <p>
              ...
              <div className="p-8 border rounded-xl shadow">
                <img src="/images/s-9/s9-4.png" alt="" className="max-w-lg mx-auto" />
              </div>
            </div>
          </div>
        </div>
