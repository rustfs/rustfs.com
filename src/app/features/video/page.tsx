...
export const metadata: Metadata = withMetadata({
  title: '视频存储降本解决方案',
  description: '通过对象存储和混合云的方式，帮助视频存储实现极剧降本'
})
...
export default function Video() {
  return (
    <div className="leading-loose">
      ...
      <div className="relative bg-cover bg-center bg-no-repeat text-white" style={{ backgroundImage: 'url(/images/banner-s/s-13.png)' }}>
      ...
      <div className="bg-muted">
        <div className="mx-auto max-w-screen-xl py-20">
          <h2 className="text-primary  text-center text-3xl font-bold">视频存储的<span className="text-pink-600">痛点</span></h2>
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="container mx-auto py-12 xl:py-24">
          ...
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">前端监控视频可通过三种方式上云</h4>
        ...
        <div className="container mx-auto space-y-10 py-12 xl:py-24">
          ...
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">视频上传自动加密</h4>
          ...
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">版本保护</h4>
