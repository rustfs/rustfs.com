...
export const metadata: Metadata = withMetadata({
  title: '面向 VMWare Tanzu 容器平台的 RustFS',
  description: 'RustFS 在 VMWare Tanzu 上运行有三个原因。'
})

/* eslint-disable @next/next/no-img-element */
export default function Tanzu() {
  return (
    <div>
      ...
      < div className="relative bg-gradient-to-t from-blue-600 to-blue-200 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/images/framework/banner-1.png)' }}>
        <div className="relative z-10 space-y-20 px-6 py-16 text-center text-white">
          <h1 className="  text-5xl font-bold">面向 VMWare Tanzu <br />
            容器平台的 RustFS</h1>
          <p className="mt-4 text-lg"></p>
          <div className="mx-auto max-w-screen-xl">
            <div className="space-y-20 rounded-lg bg-black/60 p-4 shadow lg:p-20">
              <h2 className="text-4xl font-bold">客户在VMWare Tanzu 上运行 RustFS 有三个原因。</h2>
              <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-3">
                ...
                <div className="space-y-10">
                  ...
                  <p>在 VMWare Tanzu 上运行 RustFS 可以灵活地 控制软件堆栈，从而避免云锁定。</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="container mx-auto space-y-12 py-12 xl:py-24">
          <div className="space-y-10">
            <p>VMWare Tanzu 是一个企业级 Kubernetes 容器平台，具有全栈自动化运维功能，可管理混合云、多云和边缘部署。VMWare Tanzu 包括企业级 Linux 操作系统、容器运行时、网络、监控、注册表以及身份验证和授权解决方案。</p>
            <p>RustFS 原生集成了 VMWare Tanzu，可以更轻松地将自己的大规模多租户对象存储作为服务进行操作。RustFS Operator 可与 VMWare Tanzu 工具链（例如 VMWare Tanzu Cluster Manager CLI 和 Quay 容器注册表）配合使用，确保您从 VMWare Tanzu 生态系统的投资中获得最大收益。</p>
            <div className="rounded-xl border bg-white p-8 shadow">
              <img src="/images/framework/sec1-1.png" alt="" className="mx-auto max-w-3xl" />
            </div>
            <p>RustFS 提供了一个一致、高性能和可扩展的对象存储，因为它在设计上是 Kubernetes 原生的，并且从一开始就与 S3 兼容。开发人员可以轻松地为在 VMWare Tanzu 上运行的所有云原生应用程序获取与 Amazon S3 兼容的持久存储服务。与 AWS S3 不同，RustFS 使应用程序能够跨任何多云和混合云基础设施进行扩展，并且仍然可以在 VMWare Tanzu 生态系统中进行管理，而不会受到公有云的锁定。</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-muted">
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto space-y-12 py-12 xl:py-24">
            <h2 className="text-primary  text-center text-4xl font-bold">RustFS Operator 与 VMWare Tanzu 功能原生集成，以提供：</h2>
