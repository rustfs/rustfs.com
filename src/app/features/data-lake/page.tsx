    ...
    <div>
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="container mx-auto space-y-12 py-12 ">
          <h4 className="text-primary  text-center text-xl font-bold">RustFS 为现代数据湖/湖仓一体提供统一的存储解决方案，这些可以在任何地方运行：<br />私有云、公共云、 Colos、裸机 - 甚至在边缘。是的 快速、可扩展、云原生且随时可用 - 包括所有电池。</h4>
        ...
        <div className="container mx-auto py-12 ">
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">打开表格格式就绪</h4>
            ...
            <div>
              <img src="/images/p-1/pci1.png" alt="" className="mx-auto w-full max-w-lg bg-white" />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto py-12 ">
          <div className="text-center">
            <div className="flex flex-col gap-8">
              <h4 className="text-primary text-2xl font-bold">多引擎</h4>
        ...
        <div className="container mx-auto py-12 ">
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">饿</h4>
        ...
        <div className="container mx-auto py-12 ">
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">ELT 或 ETL - 它只是工作</h4>
