    ...
    <div className="leading-loose">
      ...
      <div className="bg-gray-100 py-20">
        <div className="mx-auto max-w-7xl text-center">
          <h2 className="text-3xl font-bold text-neutral-800">存储信创实施<span className="text-pink-600">痛点</span></h2>
      ...
      {/* Advantages Section */}
      <div className="flex flex-col gap-12 bg-white py-16 text-neutral-800 xl:gap-24">
        <div className="mx-auto max-w-7xl px-6">
          <h3 className="mb-10 text-center text-3xl font-bold ">
            使用 RustFS 构建信创存储的优势
          </h3>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            <div className="flex flex-col justify-center rounded-lg border p-6 text-center dark:border-neutral-300">
        ...
        <div className="mx-auto max-w-screen-xl text-neutral-800 ">
          <div className="container mx-auto grid grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
            <div>
              <h4 className="mb-4  text-2xl font-bold text-neutral-800">降低违规风险</h4>
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto grid grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
            ...
            <div>
              <h4 className="mb-4  text-2xl font-bold text-neutral-800">节省项目上线时间</h4>
              <p className="text-gray-600">
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto grid grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
            <div>
              <h4 className="mb-4  text-2xl font-bold text-neutral-800">支持国产系统</h4>
              <p className="text-gray-600">
