    ...
    <div className="space-y-8 leading-loose">
      ...
      <div className="bg-gray-100 py-20">
        <div className="mx-auto max-w-7xl text-center">
          <h2 className="text-foreground text-3xl font-bold">存储信创实施<span className="text-pink-600">痛点</span></h2>
      ...
      {/* Advantages Section */}
      <div className="flex flex-col gap-12 bg-white py-16 xl:gap-24">
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto grid grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
            <div>
              <h4 className="text-foreground mb-4 text-2xl font-bold">降低违规风险</h4>
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto grid grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
            ...
            <div>
              <h4 className="text-foreground mb-4 text-2xl font-bold">节省项目上线时间</h4>
              <p className="text-gray-600">
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto grid grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
            <div>
              <h4 className="text-foreground mb-4 text-2xl font-bold">支持国产系统</h4>
              <p className="text-gray-600">
