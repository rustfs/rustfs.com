    ...
    <div className="leading-loose">
      ...
      <div className="bg-gray-100">
        <div className="mx-auto max-w-screen-xl py-20">
          <h2 className="text-foreground text-center text-3xl font-bold">工业生产中海量数据的长久保存，给<span className="text-pink-600">成本</span>带来了巨大的<span className="text-pink-600">烦恼</span></h2>
        ...
        <div className="container mx-auto space-y-10 py-12 xl:py-24">
          ...
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-foreground text-2xl font-bold">SSD 和HDD 分层存储降低成本</h4>
              <p>
          ...
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-8">
              <h4 className="text-foreground text-2xl font-bold">冷备存储降低成本</h4>
          ...
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-foreground text-2xl font-bold">多云转换降低成本</h4>
              <p>
