...
export const metadata: Metadata = withMetadata({
  title: '用于 Commvault 备份、恢复和复制的高性能对象存储',
  description: '简单。可 伸缩。快。防勒索软件。换句话说，正是你想要的。'
})
...
export default function Commvault() {
  return (
    <div className="leading-loose">
      ...
      <div className="relative bg-cover bg-center bg-no-repeat text-white" style={{ backgroundImage: 'url(/images/banner-bg/banner-7.png)' }}>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-primary  text-2xl font-bold">简单 = 安全。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-primary  text-2xl font-bold">简单交付规模</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-primary  text-2xl font-bold">原子能</h4>
