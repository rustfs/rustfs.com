    ...
    <div className="space-y-8 leading-loose">
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="container mx-auto space-y-12 py-12 xl:py-12">
          <h4 className="text-center  text-xl font-bold text-neutral-800">RustFS 是唯一一个具有性能和规模的对象存储平台， 可以介入并取代传统但任务关键型的 Hadoop HDFS 部署。</h4>
        </div>
        ...
        <div className="container mx-auto py-12 xl:py-24">
          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-2xl  font-bold text-neutral-800">现代数据就绪</h4>
        ...
        <div className="container mx-auto space-y-8 py-12 xl:py-16">
          ...
          <div className="flex items-center gap-10 rounded-xl bg-gradient-to-r from-[#ecd9fd] to-[#f0b2d5] p-10">
            <div className="flex-1">RustFS的简单性、可管理性、可扩展性、性能，再加上它是为分解世界而构建的，这意味着总拥有成本大大低于Hadoop HDFS的传统甚至现代实现。借助 RustFS，企业可以以更低的价格做更多的事情、连接更多、增长更多——无论是现在还是随着时间的推移。</div>
