    ...
    <div>
      ...
      <div className="relative bg-gradient-to-t from-blue-600 to-blue-200 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/images/framework/banner-1.png)' }}>
        <div className="relative z-10 space-y-20 px-6 py-16 text-center">
          <h3 className="text-primary-foreground text-5xl font-bold">适用于 Amazon Elastic<br />
            Kubernetes Service的 RustFS</h3>
          <p className="mt-4 text-lg"></p>
          <div className="mx-auto max-w-screen-xl">
            <div className="space-y-20 rounded-lg bg-black/60 p-4 shadow lg:p-20">
              <h2 className="text-primary-foreground text-4xl font-bold">客户在Amazon Elastic 上运行 RustFS 有三个原因。</h2>
      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="container mx-auto space-y-12 py-12 xl:py-24">
          <h2 className="text-neutral-800  text-center text-4xl font-bold">建筑</h2>
      ...
      <div className="bg-neutral-100">
        <div className="mx-auto max-w-screen-xl">
          <div className="container mx-auto space-y-12 py-12 xl:py-24">
            <h2 className="text-neutral-800  text-center text-4xl font-bold">RustFS Operator 与 Amazon EKS 功能原生集成，以提供：</h2>
