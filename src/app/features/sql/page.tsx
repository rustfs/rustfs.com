...
export default function ColdArchiving() {
  return (
    <div className="leading-loose">
      ...
      <div className="text-primary-foreground relative bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/images/banner-bg/banner-4.png)' }}>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">任何对任何，所有时间。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">连接到数据，不要移动它。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">大规模性能 -适用于所有企业数据。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">像您梦寐以求的那样备份和恢复</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">安全且可用</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">流式传输边缘</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">云作为运营模式 - 从 S3 开始</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">边缘 AI 存储</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">ML/AI 工作负载的生命周期管理</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">AI/ML 工作流的对象保留</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-foreground text-2xl font-bold">核心 AI 数据集的数据保护</h4>
