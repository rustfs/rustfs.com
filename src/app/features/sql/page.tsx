          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">任何对任何，所有时间。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">连接到数据，不要移动它。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">大规模性能 -适用于所有企业数据。</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">像您梦寐以求的那样备份和恢复</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">安全且可用</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">流式传输边缘</h4>
            ...
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-8">
                <h4 className="text-2xl  font-bold text-neutral-800">核心 AI 数据集的数据保护</h4>
