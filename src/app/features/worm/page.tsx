    ...
    <div className="space-y-8 leading-loose">
        ...
        <div className="container mx-auto py-12">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full p-6 md:w-1/2">
              <img src="/images/s-3/s3-1.png" alt="" className="mx-auto max-w-sm" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="container mx-auto space-y-6 p-12 leading-loose">
          <h3 className="text-primary text-xl font-bold">对象保留</h3>
          <p>
      ...
      <div className="bg-neutral-100">
        <div className="mx-auto max-w-screen-xl">
          {/* Standard Boxes Section */}
          <div className="container mx-auto space-y-6 p-12 leading-loose">
            <h2 className="text-center text-3xl font-bold">RustFS 数据不变性达到或超过 Cohasset 认证标准</h2>
