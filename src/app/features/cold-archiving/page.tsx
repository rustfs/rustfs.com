...
export const metadata: Metadata = withMetadata({
  title: '对象存储冷归档解决方案',
  description: '海量机密和重要数据，以光盘为媒介实现数百年的脱网、脱电存储不丢失'
})
...
export default function ColdArchiving() {
  return (
    <div className="leading-loose">
      ...
      <div className="relative bg-cover bg-center bg-no-repeat text-white" style={{ backgroundImage: 'url(/images/banner-s/s-10.png)' }}>
      ...
      <div className="bg-background">
        <div className="mx-auto max-w-screen-xl py-20">
          <h2 className="text-primary text-center text-3xl font-bold">冷归档存储<span className="text-pink-600">痛点</span></h2>
      ...
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="container mx-auto space-y-10 py-12">
          ...
          <p className="text-primary text-center text-xl">单机柜工作功率160W，待机功率仅7W，大大降低电费投入，绿色节能</p>

          <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-8">
              <h4 className="text-primary  text-2xl font-bold">大中型数据中心能耗测算</h4>
      ...
      <div className="bg-black bg-cover bg-center bg-no-repeat py-10" style={{ background: 'url(/images/s-13/banner.png);' }}>
