...
export default function Pricing() {
  ...
  return (
    <div className="bg-neutral-100 leading-loose">
      {/* Background Banner Section */}
      <div className="text-primary-foreground relative bg-cover bg-bottom bg-no-repeat" style={{ backgroundImage: 'url(/images/trademark/banner.png)' }}>
      ...
      <div className="bg-background py-4 lg:py-8 xl:py-12">
        <div className="mx-auto max-w-screen-xl">
          <div className="prose rounded-lg border p-4 lg:p-8 xl:p-12">
