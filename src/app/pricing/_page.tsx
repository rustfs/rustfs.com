  ...
  return (
    <>
      <div className="leading-loose">
        ...
        <div className="relative bg-cover bg-center bg-no-repeat text-white" style={{ backgroundImage: 'url(/images/banner-bg/banner.png)' }}>
            ...
            <div className="w-full flex-1 pt-8 xl:pt-16">
              {tab === 'open-source' && (
                <div className="grid w-full grid-cols-1 items-center gap-6 text-center lg:grid-cols-3">
                  <div className="bg-background flex flex-col items-center justify-center space-y-10 rounded-xl border p-8 shadow-lg xl:p-12">
                    <h4>SLA 48 小时响应服务</h4>
              ...
              {tab === 'business' && (
                <div className="grid w-full grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-12">
                  <div className="bg-background flex flex-col space-y-10 rounded-xl border border-t-8 border-t-gray-600 p-8 shadow-lg xl:p-12">
                  ...
                  <div className="bg-background flex flex-col space-y-10 rounded-xl border border-t-8 border-t-blue-600 p-8 shadow-lg xl:p-12">
                    <div className="space-y-6">
                      <div className="flex items-start justify-between">
