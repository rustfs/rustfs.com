---
title: 'Drop-in Binary Replacement: Migrate from MinIO to RustFS'
slug: binary-replacement-a-simple-way-to-migrate-from-minio-to-rustfs
description: >-
  Today we are excited to announce that RustFS has introduced a key feature in
  the latest release (1.0.0-alpha.89):...
...
tags:
  ...
  - Best Practices
  - General Usage
image: '/images/blog/binary-replacement-a-simple-way-to-migrate-from-minio-to-rustfs/minio-2-rustfs-migration.png'
---
Today we are excited to announce that RustFS has introduced a key feature in the latest release (`1.0.0-alpha.8`9): users can now migrate from MinIO to RustFS through direct binary replacement.
...
![Your MinIO Instance](/images/blog/binary-replacement-a-simple-way-to-migrate-from-minio-to-rustfs/rkzulxu5be.png)
...
![Your RustFS Instance](/images/blog/binary-replacement-a-simple-way-to-migrate-from-minio-to-rustfs/bjlrwg_cwx.png)
