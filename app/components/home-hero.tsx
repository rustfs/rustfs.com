    ...
    <section className="mx-auto max-w-7xl overflow-hidden px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto font-display text-4xl font-extrabold tracking-wide text-primary sm:text-5xl md:text-6xl xl:text-7xl flex flex-col items-center">
        <div className={cn('flex flex-col items-center w-full', tw('xl:flex-row xl:justify-center', ''))}>
          ...
          <div className={cn('flex flex-col items-center justify-center w-full', locale == 'en' ? '' : 'xl:w-[300px]')}>
            <span className={cn('relative whitespace-nowrap text-blue-600', locale == 'en' ? 'inline-flex justify-center mx-auto' : 'inline-flex')}>
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className={cn("absolute top-2/3 mx-auto w-full h-[0.58em] fill-blue-300/70", locale == 'en' ? 'w-[600px]' : 'w-[300px]')}
              ...
              <span className={cn('relative flex', locale == 'en' ? 'justify-center' : 'xl:w-[300px]')}>
