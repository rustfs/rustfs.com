    ...
    <section className="border-t border-border py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          <Link
            href={stories[0].href}
            className="motion-card group flex flex-col border border-border bg-card transition-colors hover:bg-muted/25 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-6 sm:p-8">
              ...
              <div className="mt-auto flex items-center justify-between border-t border-border pt-8 text-sm font-semibold text-muted-foreground transition-colors group-hover:text-foreground">
          ...
          <div className="grid gap-4">
            <Link
              href={stories[1].href}
              className="motion-card group border border-border bg-muted/40 p-6 transition-colors hover:bg-muted/60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand sm:p-8"
            ...
            >
              ...
              <div className="mt-8 flex items-center justify-between border-t border-border pt-6 text-sm font-semibold text-muted-foreground transition-colors group-hover:text-foreground">
